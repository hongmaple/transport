<template>
	<view>
		...
		<view class="help-container">
		  <view v-for="(item, findex) in helpList" :key="findex" :title="item.title" class="list-title">
		    ...
		    <view class="childList">
		      <view class="question" hover-class="hover"
		        ...
		        <view class="line" v-if="zindex !== helpList.length - 1"></view>
		      </view>
		    </view>
		  </view>
		</view>
...
<script>
	import {listHelp} from '@/api/maple/help.js';
  export default {
    data() {
      return {
		helpList: []
