package com.ruoyi.maple.config;
...
import com.ruoyi.maple.config.interceptor.AliPayMessageInterceptor;
import com.ruoyi.maple.handlers.WxPayMessageHandler;
...
//        数据库文件存放 /doc/sql目录下
    ...
    public void configure(PayMessageConfigurer configurer) {
        ...
        configurer.addHandler(aliPaymentPlatform, wxPayMessageHandler);
